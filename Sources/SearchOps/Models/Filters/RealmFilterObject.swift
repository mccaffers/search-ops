...
public class RealmFilterObject: Object {
  ...
  public func equals (input: RealmFilterObject?) -> Bool {
    ...
    guard doBothObjectsMatch(self.query, input?.query) else { return false }
    ...
    guard doBothObjectsMatch(self.dateField, input?.dateField) else { return false }
    ...
    guard doBothObjectsMatch(self.relativeRange, input?.relativeRange) else { return false }
    ...
    guard doBothObjectsMatch(self.absoluteRange, input?.absoluteRange) else { return false }
  ...
  func doBothObjectsMatch <T>(_ obj1: T?, _ obj2: T?) -> Bool {
